...
{\large \textbf{\MakeUppercase{KONSTRUKSI DAN EVOLUSI
PERANGKAT LUNAK}}} \\[0.4cm]
...
\begin{tabular}{@{}l l @{}}
  ...
  \textbf{Kelas}          & : PL5A1 \\
  \textbf{Dosen Pengampu} & : Dosen Pengampu KEPL
\end{tabular} \\[1.2cm]
...
\begin{enumerate}
   ...
   \item Mahasiswa mampu menerapkan Conventional Commits dan Pull Request sebagai gerbang integrasi.
   \item Mahasiswa mampu menyusun pipeline CI minimal dua job yang berjalan hijau di GitHub Actions.
   \item Mahasiswa mampu mengkonfigurasi branch protection rule pada \texttt{main} dan \texttt{dev}.
\end{enumerate}
\clearpage
